...
<body onload="searchFocus();">
  ...
  <div id="mainContainer">
    <div>
      <div id="productsContainer" class="products-container wrapped-flex outer">
        <div id="mainProduct" class="wrapped-flex">
          <?php 
          include('./components/Products.php'); 
          ?>
        </div>
        <button class="btn bg-blue btn-primary m-auto">Selanjutnya...</button>
      </div>
